...
using Radon.Client.Authentication;
...
namespace Radon.Client.Http
{
    ...
    public class Connection : IConnection
    {
        ...
        /// </param>
        public Connection(Uri baseAddress, string userAgent, IHttpClient httpClient)
            : this(baseAddress, userAgent, AnonymousCredentials, httpClient, new SerializationService())
        {
        }
        ...
        public Connection(Uri baseAddress, string userAgent, ICredentialStore credentialStore, IHttpClient httpClient, ISerializationService serializer)
            : this(baseAddress, userAgent, credentialStore, httpClient, serializer, new JsonHttpPipeline(serializer))
        {
        }
