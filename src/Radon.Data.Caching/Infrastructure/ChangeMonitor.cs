...
namespace Radon.Data.Caching.Infrastructure
{
    public abstract class ChangeMonitor : IDisposable
    {
        ...
        private readonly static object NotSet = new object();

        private SafeBitVector32 _flags;
        private OnChangedCallback _onChangedCallback;
        private object _onChangedState = NotSet;
        ...
        private void OnChangedHelper(object state)
        {
            ...
            Interlocked.CompareExchange(ref _onChangedState, state, NotSet);
        ...
        public void Dispose()
        {
            ...
            if (!_flags[Initialized])
            {
                throw new InvalidOperationException("Initialization not complete");
            }
