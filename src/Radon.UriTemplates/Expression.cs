...
namespace Radon.UriTemplates
{
    internal class Expression : IUriComponent
    {
        ...
        {
            Ensure.ArgumentIsNotNull(op, nameof(op));
            Ensure.ArgumentIsNotNull(varSpecs, nameof(varSpecs));
        ...
        private bool Resolve(StringBuilder builder, VarSpec varSpec, object value, bool hasPrefix)
        {
            ...
            if (stringValue == null)
            {
                ...
                if (collectionValue == null)
                {
                    ...
                    {
                        throw new UriTemplateException(
                            $"Invalid value type of variable \"{value.GetType()}\". Expected: string or IEnumerable<string> or IDictionary<string, string>.");
                    }
        ...
        private static void CheckCompositeVariables(VarSpec varSpec)
        {
